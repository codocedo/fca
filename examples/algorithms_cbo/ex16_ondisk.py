...
def exec_ex16(filepath, min_sup=0, output_path=None):
    """
...
if __name__ == '__main__':
    __parser__ = argparse.ArgumentParser(
        description='Example 16: CbO OnDisk - Streaming patterns to disk'
    )
    ...
    exec_ex16(__args__.context_path, __args__.min_sup, __args__.output_path)
