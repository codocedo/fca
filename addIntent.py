...
# Kyori code.
import sys
from fca.algorithms.addIntent import add_intent, read_lattice_as_dict
...
if __name__ == "__main__":
    ...
    __lattice__ = add_intent(__representations__, silent=False, pattern=SetPattern)
    print read_lattice_as_dict(__lattice__)
